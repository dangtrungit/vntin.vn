...
<form method="POST">
    <table border="1px" align="center">
        ...
        <tr>
            <td>Ten</td>
            <td><input type="text" name="txttenlt" id="txttenlt" value="<?php
        ...
        <tr>
            <td>ThuTu</td>
            <td><input type="text" name="txtthutult" id="txtthutult" value="<?php echo $row_loaitin['ThuTu'] ?>"/></td>
        </tr>
        <tr>
            <td>AnHien</td>
            <td>
                <input <?php if ($row_loaitin['AnHien'] == 1) echo "checked= 'checked'" ?> type="radio"
                                                                                           name="rdhienanlt"
                                                                                           id="rdhienanlt" value="1"/>Hiện
                <input <?php if ($row_loaitin['AnHien'] == 0) echo "checked= 'checked'" ?> type="radio"
                                                                                           name="rdhienanlt"
                                                                                           id="rdhienanlt" value="0"/>Ẩn
            </td>
        </tr>
        </tr>
        <tr>
            <td>
                <select id="idTLlt" name="idTLlt">
                    ...
                    <option
                        <?php
                        if ($row_theloai['idTL'] == $row_loaitin['idTL'])
    ...
    <table align="center">
        <tr id="buttonthem">
            <td>
                <button id="btnsualt" name="btnsualt"> Update</button>
            </td>
        </tr>
